...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, name, stride=1):
        super().__init__()
        self.name = name
        # residual function
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, num_block, num_classes=100):
        ...
        self.conv2_x = self._make_layer(block, 64, num_block[0], 1, 'conv2')
        self.conv3_x = self._make_layer(block, 128, num_block[1], 2, 'conv3')
        self.conv4_x = self._make_layer(block, 256, num_block[2], 2, 'conv4')
        self.conv5_x = self._make_layer(block, 512, num_block[3], 2, 'conv5')
    ...
    def _make_layer(self, block, out_channels, num_blocks, stride, name):
        ...
        for i, stride in enumerate(strides):
            layers.append(
                block(self.in_channels, out_channels, name + f"_{i}", stride))
    ...
    def forward(self, x):
        ...
        print('full_connection', output.shape)
...
def test():
    input = np.random.randn(32, 3, 32, 32)
